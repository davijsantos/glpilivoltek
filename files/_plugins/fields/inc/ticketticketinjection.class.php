...
class PluginFieldsTicketticketInjection extends PluginFieldsTicketticket implements PluginDatainjectionInjectionInterface
{
    ...
    **/
    ...
    static function getTypeName($nb = 0) {
        return Ticket::getTypeName() . " - Tickets";
    }
